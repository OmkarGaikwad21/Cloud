...
# Create the directory for CDH parcels
...
subprocess.run(["sudo", "wget", "https://archive.cloudera.com/cdh7/7.1.7/parcels/manifest.json", "-P", "/var/www/html/cloudera-repos/cdh7/7.1.7.0/parcels"])
