...
job_list = [
    ...
    'sudo mv CDH-7.1.7-1.cdh7.1.7.p0.15945976-el7.parcel* /var/www/html/cloudera-repos/cm7/',
    'sudo mv KEYTRUSTEE_SERVER-7.1.7.0-1.keytrustee7.1.7.0.p0.15945976-el7.parcel* /var/www/html/cloudera-repos/cm7/',
    'sudo mv manifest.json /var/www/html/cloudera-repos/cm7/',
