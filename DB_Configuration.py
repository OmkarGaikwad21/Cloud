...
# Uninstall existing mysql community release
subprocess.run("sudo rpm -e --noscripts mysql80-community-release-el7-10.noarch", shell=True)  

# Clear yum cache
subprocess.run("sudo yum clean all", shell=True)

# Install v9 release package
...
result = subprocess.check_output("sudo grep 'temporary password' /var/log/mysqld.log", shell=True, text=True)
